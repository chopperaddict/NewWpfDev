...
namespace NewWpfDev . Dapper
{
    ...
    public static class DapperGeneric<T, U, V>
    {
        ...
        // how to access <T> parameters in any generic method
        public static bool CallGeneric<T1> ( T1 arg, out int ArgType)
        {
            ArgType = 0;
            ...
            Debug . WriteLine ($"arg type is {type}");
        ...
        public static GenericClass ParseDapperRowGen ( 
            dynamic buff ,
